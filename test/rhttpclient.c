...
/* TEMP (rpoll dead-socket validation, do not merge): hammer the mid-request
 * force-close so the Windows rpoll race that strands an unarmable socket in the
 * wait set hits within one run. */
