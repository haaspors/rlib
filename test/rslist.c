...
RTEST (rslist, add, RTEST_FAST)
{
  ...
  r_assert_cmpptr (head->next->data, ==, PTR_CAFEBABE);
...
RTEST (rslist, nth, RTEST_FAST)
{
  ...
  r_assert_cmpptr (r_slist_nth (head, 0)->data, ==, PTR_BAADFOOD);
  r_assert_cmpptr (r_slist_nth (head, 1)->data, ==, PTR_DEADBEEF);
  r_assert_cmpptr (r_slist_nth (head, 2)->data, ==, PTR_CAFEBABE);
...
RTEST (rslist, contains, RTEST_FAST)
{
  ...
  r_assert (!r_slist_contains (head->next, PTR_BAADFOOD));
