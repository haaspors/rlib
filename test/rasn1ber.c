...
RTEST (rasn1ber, new, RTEST_FAST)
{
  ...
  r_assert_cmpptr (r_asn1_ber_decoder_new (NULL, 42), ==, NULL);
  r_assert_cmpptr (r_asn1_ber_decoder_new (foobar, 0), ==, NULL);
  r_assert_cmpptr ((dec = r_asn1_ber_decoder_new (foobar, sizeof (foobar))), !=, NULL);
...
RTEST (rasn1ber, sequence_primitives, RTEST_FAST)
{
  ...
  r_assert_cmpint (r_asn1_ber_tlv_parse_integer (&tlv, &v_int), ==, R_ASN1_DECODER_WRONG_TYPE);
  r_assert_cmpint (r_asn1_ber_tlv_parse_boolean (&tlv, &v_bool), ==, R_ASN1_DECODER_OK);
  r_assert (v_bool);
  ...
  r_assert_cmpint (r_asn1_ber_tlv_parse_integer (&tlv, &v_int), ==, R_ASN1_DECODER_OK);
  ...
  r_assert_cmpint (r_asn1_ber_tlv_parse_boolean (&tlv, &v_bool), ==, R_ASN1_DECODER_WRONG_TYPE);
  r_assert_cmpint (r_asn1_ber_tlv_parse_integer (&tlv, &v_int), ==, R_ASN1_DECODER_OVERFLOW);
  r_assert_cmpint (r_asn1_ber_tlv_parse_mpint (&tlv, &v_mpint), ==, R_ASN1_DECODER_OK);
  ...
  r_assert_cmpint (r_asn1_ber_tlv_parse_oid (&tlv, v_oid, &size_oid), ==, R_ASN1_DECODER_OK);
  ...
  r_assert_cmpint (r_asn1_ber_decoder_out (dec, &tlv), ==, R_ASN1_DECODER_EOS);
  r_asn1_ber_decoder_unref (dec);
}
RTEST_END;
...
RTEST (rasn1ber, invalid_decode_args, RTEST_FAST)
{
  ...
  r_assert_cmpint (r_asn1_ber_decoder_next (NULL, &tlv), ==, R_ASN1_DECODER_INVALID_ARG);
  r_assert_cmpint (r_asn1_ber_decoder_next (dec, NULL), ==, R_ASN1_DECODER_INVALID_ARG);

  r_assert_cmpint (r_asn1_ber_decoder_into (NULL, &tlv), ==, R_ASN1_DECODER_INVALID_ARG);
  r_assert_cmpint (r_asn1_ber_decoder_into (dec, NULL), ==, R_ASN1_DECODER_INVALID_ARG);
  r_assert_cmpint (r_asn1_ber_decoder_into (dec, &tlv), ==, R_ASN1_DECODER_INVALID_ARG);

  r_assert_cmpint (r_asn1_ber_decoder_out (NULL, &tlv), ==, R_ASN1_DECODER_INVALID_ARG);
  r_assert_cmpint (r_asn1_ber_decoder_out (dec, NULL), ==, R_ASN1_DECODER_INVALID_ARG);
  r_assert_cmpint (r_asn1_ber_decoder_out (dec, &tlv), ==, R_ASN1_DECODER_INVALID_ARG);

  r_assert_cmpint (r_asn1_ber_decoder_next (dec, &tlv), ==, R_ASN1_DECODER_OK);
  r_assert_cmpint (r_asn1_ber_decoder_out (dec, &tlv), ==, R_ASN1_DECODER_INVALID_ARG);
  r_assert_cmpint (r_asn1_ber_decoder_next (dec, &tlv), ==, R_ASN1_DECODER_EOS);
...
RTEST (rasn1ber, incomplete_stream, RTEST_FAST)
{
  ...
  r_assert_cmpint (r_asn1_ber_decoder_next (dec, &tlv), ==, R_ASN1_DECODER_OK);
  r_assert_cmpint (r_asn1_ber_decoder_next (dec, &tlv), ==, R_ASN1_DECODER_OVERFLOW);
